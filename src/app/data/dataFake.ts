export const dataFake = [
  ...
  },
  {
    ...
    "description": "Após os eventos de Capitão América: Guerra Civil (2016), o príncipe T'Challa volta para sua casa na isolada e tecnologicamente desenvolvida nação",
  ...
  },
  {
    ...
    "description": "É um filme de ação, aventura e fantasia estadunidense de 2000, baseado no grupo homônimo da Marvel Comics",
